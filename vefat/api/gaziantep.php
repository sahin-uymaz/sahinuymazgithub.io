...
<title>Türkiye Vefat Bilgi Merkezi | Şahin Uymaz</title>

<meta name="description" content="Türkiye genelinde kamuya açık vefat ve defin bilgilerini tek noktadan arayın.">
...
body{
    ...
    background:
        radial-gradient(circle at top right, rgba(180,145,60,.12), transparent 30%),
        linear-gradient(135deg,#07111f,#0b1728 55%,#101c2e);
    color:#fff;
    min-height:100vh;
}
...
select:focus{
    border-color:#d7b76a;
    box-shadow:0 0 0 3px rgba(215,183,106,.10);
}
...
.search-button{
    ...
    border:0;
    border-radius:11px;
    background:linear-gradient(135deg,#d7b76a,#f0d58c);
    color:#07111f;
    font-size:16px;
    font-weight:900;
    letter-spacing:.5px;
...
.search-button:hover{
    ...
    box-shadow:0 10px 25px rgba(215,183,106,.20);
}
...
.card:hover{
    border-color:rgba(215,183,106,.30);
...
<footer class="footer">
    ...
    Türkiye Vefat Bilgi Merkezi yalnızca kamuya açık olarak yayımlanan
    ve teknik olarak erişilebilen vefat ve defin bilgilerini sunmayı amaçlar.

    <br><br>

    Kapalı, giriş gerektiren veya dışarıdan erişime izin vermeyen
    veri kaynakları sisteme dahil edilmez.

    <br><br>

    Bir kişinin burada bulunmaması, kişinin vefat etmediği anlamına gelmez.
...
function renderResults(data){
    ...
    if(data.records.length === 0){
        ...
        showStatus(
            "Seçtiğiniz kriterlere uygun kamuya açık kayıt bulunamadı.",
            "success"
        );
